...
const DemoSectionNew = () => {
  ...
  const [demoData, setDemoData] = useState({
    ...
    autism: { blinkRate: 18, gazeDeviation: 30, facialAsymmetry: 12, expressivity: 40, tremorIndicators: 8 }
  });
  ...
  const demoScenarios = {
    ...
    autism: {
      ...
      description: "Atypical gaze patterns, social communication differences",
      risk: 35,
      color: "purple"
    }
  };
                ...
                {demoMode === 'autism' && (
                  <>
                    <div className="flex items-center text-sm">
                      ...
                      <span>Atypical gaze patterns</span>
                    </div>
                    <div className="flex items-center text-sm">
                      <div className="w-2 h-2 bg-purple-500 rounded-full mr-3"></div>
                      <span>Variable expressivity</span>
                    </div>
                    <div className="flex items-center text-sm">
                      <div className="w-2 h-2 bg-purple-500 rounded-full mr-3"></div>
                      <span>Social communication differences</span>
                    </div>
                  </>
                )}
                {demoMode === 'normal' && (
