...
import FaceAnalysisWorking from './FaceAnalysisWorking';
import VoiceAnalysisWorking from './VoiceAnalysisWorking';
import DemoSectionNew from './DemoSectionNew';

const CombinedAnalysisWorking = () => {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setCombinedRisk(prev => ({
        face: 20 + Math.random() * 60,
        voice: 15 + Math.random() * 70,
        overall: 10 + Math.random() * 80
      }));
    }, 3000);
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        {activeTab === 'face' && <FaceAnalysisWorking />}
        {activeTab === 'voice' && <VoiceAnalysisWorking />}
...
export default CombinedAnalysisWorking;
