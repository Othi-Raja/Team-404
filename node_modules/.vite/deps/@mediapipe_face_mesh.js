                  ...
                  return Ub("createMediapipeSolutionsWasm", { locateFile: d.locateFile }), Ub("createMediapipeSolutionsPackedAssets", { locateFile: d.locateFile }), l = g.filter(function(t) {
                    ...
                    return Z(e, function x() {
                      ...
                      return O(x, function(I) {
                        if (1 == I.g)
                          return z = window.createMediapipeSolutionsWasm, E = window.createMediapipeSolutionsPackedAssets, N(I, z(E), 2);
                        F.h = I.h;
                        I.g = 0;
                      });
                    });
                      ...
                      switch (n.type) {
                        case "video":
                          ...
                          if ("undefined" !== typeof HTMLVideoElement && t instanceof HTMLVideoElement) {
                            ...
                            "undefined" !== typeof HTMLImageElement && t instanceof HTMLImageElement ? (z = t.naturalWidth, x = t.naturalHeight) : (z = t.width, x = t.height);
                        ...
                        case "detections":
                          ...
                          for (x = 0; x < t.length; ++x) {
                            ...
                            if (null != C && null != C) {
                              ...
                              C = Q;
                              for (D = R; 0 < D || 127 < C; )
                                q.push(C & 127 | 128), C = (C >>> 7 | D << 25) >>> 0, D >>>= 7;
                              q.push(C);
                            }
                            rb(p, A);
                            H = $a(H);
                            ...
                            if (z.O)
                              for (E = 0; E < z.O.length; ++E)
                                p = z.O[E], A = p.visibility ? true : false, F = m.data, I = F.addNormalizedLandmark, H = x, p = Object.assign(Object.assign({}, p), { visibility: A ? p.visibility : 0 }), A = new Ab(), X(A, 1, p.x), X(A, 2, p.y), X(A, 3, p.z), p.visibility && X(A, 4, p.visibility), q = p = new Ya(), U(q, 1, W(A, 1)), U(q, 2, W(A, 2)), U(q, 3, W(A, 3)), U(q, 4, W(A, 4)), U(q, 5, W(A, 5)), rb(A, q), p = $a(p), I.call(F, H, p);
                            if (z.M)
          ...
          return O(e, function(F) {
            switch (F.g) {
              case 1:
                ...
                h = K(Object.keys(c));
                for (k = h.next(); !k.done; k = h.next())
                  l = k.value, n = c[l], "string" !== typeof n && "texture" === n.type && void 0 !== b[n.stream] && ++f;
                1 < f && (u.G = false);
                w = K(Object.keys(c));
                k = w.next();
              case 2:
                ...
                if ("detection_list" === y.type) {
                  if (m) {
                    ...
                    for (var H = m.getLandmarksList(), p = m.getClassificationsList(), A = [], C = 0; C < I.size(); ++C) {
                      ...
                      var la = p.get(C);
                      a:
                        for (D = new yb(), la = new Sa(la); S(la); )
                          switch (la.i) {
                            case 10:
